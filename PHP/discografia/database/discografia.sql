...
INSERT INTO sottogeneri(id_sottogenere, nome_sottogenere, id_genere) VALUES (7, "Musica Da Camera", 2);
INSERT INTO sottogeneri(id_sottogenere, nome_sottogenere, id_genere) VALUES (8, "Concerto", 2);
INSERT INTO sottogeneri(id_sottogenere, nome_sottogenere, id_genere) VALUES (9, "Opera", 2);
INSERT INTO sottogeneri(id_sottogenere, nome_sottogenere, id_genere) VALUES (10, "Sinfonia", 2);
INSERT INTO sottogeneri(id_sottogenere, nome_sottogenere, id_genere) VALUES (11, "Musica Corale", 2);

INSERT INTO gruppo(id_gruppo, nome_gruppo) VALUES (1, "Muse");
INSERT INTO gruppo(id_gruppo, nome_gruppo) VALUES (2, "Slipknot");

INSERT INTO album(id_album, titolo_album, data_pubblicazione, durata_album, link, id_gruppo) VALUES (1, "Origin of Symmetry", "2001-06-18", "00:51:27.0", "https://upload.wikimedia.org/wikipedia/en/thumb/3/35/Muse_-_Origin_of_Symmetry_cover_art.png/220px-Muse_-_Origin_of_Symmetry_cover_art.png", 1);
INSERT INTO album(id_album, titolo_album, data_pubblicazione, durata_album, link, id_gruppo) VALUES (2, "The Resistance", "2011-09-11", "00:54:14.0", "https://obs.line-scdn.net/r/musicjp/c/c19cb9083t0a18187d/v256x256", 1 );
INSERT INTO album(id_album, titolo_album, data_pubblicazione, durata_album, link, id_gruppo) VALUES (3, "We Are Not Your Kind", "2019-08-09", "01:03:26.0", " dsd", 2);
