...
<html>
    ...
    <head>
        ...
        <form action=stampaArtista.php method=POST>
...
function Stampa()
{
    ...
    $queryArtista = "SELECT m.nome_artista FROM musicista m;";
    ...
    {
        $s .= "<option value=". $artista["nome_artista"] . ">" . $artista["nome_artista"] . "</option>";
    }
